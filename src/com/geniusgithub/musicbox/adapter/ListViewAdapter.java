package com.geniusgithub.musicbox.adapter;
...
public class ListViewAdapter extends BaseAdapter{
	...
	private List<MediaItem> mFileList;
	...
	public ListViewAdapter(Context context, List<MediaItem> FileList)
	{
		mFileList = FileList;
	...
	public void refreshAdapter(List<MediaItem> FileList)
	{
		mFileList = FileList;
		notifyDataSetChanged();
		log.e("refreshAdapter size = " + mFileList.size());
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		nametTextView.setText(mFileList.get(position).getTitle());
		
		TextView timeTextView = (TextView) convertView.findViewById(R.id.musicTime);
		int duration = mFileList.get(position).getDuration();
		timeTextView.setText(formatTime(duration));
		
		
		TextView pathTextView = (TextView) convertView.findViewById(R.id.musicAritst); 
		pathTextView.setText(mFileList.get(position).getArtist());
